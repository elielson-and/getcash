...
<template>
    <section class="space-y-6">
        ...
        <DangerButton @click="confirmUserDeletion">Encerrar minha conta</DangerButton>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-6 ">
                    ...
                    <TextInput id="password" required ref="passwordInput" v-model="form.password" type="password"
