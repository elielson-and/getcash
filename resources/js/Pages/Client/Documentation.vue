                    ...
                    <div class="w-full p-4">
                        ...
                        <div v-if="documentation" class="w-full">
                            ...
                            <div v-if="documentation.status == 'analysis'" role="alert"
                                class="alert bg-gray-100 border-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6"
                                    fill="none" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span>Sua documentação foi enviada e está em análise! <br>
                                    <small>Volte em algumas horas para verificar o status do seu cadastro. Assim que
                                        aprovado
                                        você poderá realizar novas solicitações.</small></span>
                            </div>

                            <div v-if="documentation.status == 'revoked'" role="alert"
                                class="alert bg-red-100 border-none">
                                ...
                                <span><b>Sua documentação foi revogada.</b> <br>
                                    ...
                                    <small><b>Motivo: </b> {{ documentation.revocation_reason }} </small>
                                </span>
                            </div>
                        </div>
                        ...
                        <div v-if="!documentation" class="w-full">
                            <form @submit.prevent="submit" enctype="multipart/form-data">
                                ...
                                <div v-if="!formStep" class="w-full"
                                    ...
                                    <div v-if="fetchedData != ''"
                                        ...
                                        As informações foram carregadas previamente, verifique se os dados estão
                                        atualizados
                                        antes
                                        de enviar para que suas futuras solicitações de serviços sejam aprovadas de
                                        forma
                                        rápida
                                        e
                                        segura.
                                    ...
                                    <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                                        ...
                                        <div class="form-control">
                                            ...
                                            <input type="text" placeholder="Digite seu nome completo"
                                                v-model="form.fullName" class="input input-bordered" required
                                                :disabled="isLoading" />
                                        </div>
                                        <div class="form-control">
                                            <label class="label">
                                        ...
                                        <div class="form-control">
                                            ...
                                            <input type="email" placeholder="Digite seu email" required
                                                v-model="form.email" class="input input-bordered"
                                                :disabled="isLoading" />
                                        </div>
                                        <div class="form-control col-span-1 md:col-span-2 lg:col-span-3">
                                            ...
                                            <input type="text" placeholder="Digite seu endereço completo" required
                                                class="input input-bordered" v-model="form.address"
                                                :disabled="isLoading" />
                                        </div>
                                ...
                                <div v-if="formStep === 1" class="w-full animate-fade-left animate-duration-[500ms]">
                                    <h2 class="text-2xl text-gray-400 text-center">Clique ou arraste as imagens para as
                                        áreas
                                        abaixo</h2>
                            ...
                            <div class="w-full border-dashed text-blue-500 bg-blue-50 p-4 mt-16 rounded-lg">
                                ...
                                quaisquer
                                análises de
                                crédito em bancos terceiros. Portanto não comprometerá seu score ou demais meios de
                                análise
                                de
